...
from app.services.rabbitmq.consumer import subscribe_to_queue, publish_message
...
class Server(metaclass=Singleton):
    ...
    async def initialize_rabbitmq(self):
        ...
        try:
            ...
            await subscribe_to_queue()  # Start consuming auth email messages
            await publish_message()  # Optional: Publish a test message
