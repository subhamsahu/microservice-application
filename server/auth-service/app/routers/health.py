...
async def auth_check_health_handler():
    ...
    try:
        ...
        if connection_obj and hasattr(connection_obj, 'engine') and connection_obj.engine:
...
async def readiness_check():
    ...
    try:
        ...
        if not (connection_obj and hasattr(connection_obj, 'engine') and connection_obj.engine):
            ready = False
